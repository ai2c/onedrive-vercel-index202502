  ...
  return (
    <Dialog.Panel className="relative">
      <Menu>
        ...
        >
          <Menu.Items className="absolute top-0 right-0 z-20 mt-8 w-28 Dialog.Panelide-y Dialog.Panelide-gray-900 overflow-auto rounded border border-gray-900/10 bg-white py-1 shadow-lg focus:outline-none dark:border-gray-500/30 dark:bg-gray-900 dark:text-white">
            {locales!.map(locale => (
              <Menu.Item key={locale}>
                ...
                >
                  <Dialog.Panel className="m-1 cursor-pointer rounded px-2 py-1 text-left text-sm font-medium hover:bg-blue-50 hover:text-blue-700 dark:hover:bg-blue-600/10 dark:hover:text-blue-400">
                    {localeText(locale)}
                  </Dialog.Panel>
                </CustomLink>
              </Menu.Item>
